...
const App = () => {
  ...
  return y("div", {
    ...
    return y("div", {
      ...
      className: `w-full text-slate-500 px-4 py-3 ${isActive ? "text-slate-950 bg-white rounded-t-xl" : "bg-gray-200"}`
    }, tab.label), activeTab === tab.value && i < 2 && y("div", {
      className: "bg-white z-20 w-2 h-2 absolute bottom-0 right-0 translate-x-2"
    }, y("div", {
      className: "bg-gray-200 w-full h-full rounded-bl-xl"
    })), activeTab === tab.value && i > 0 && y("div", {
      className: "bg-white z-20 w-2 h-2 absolute bottom-0 left-0 -translate-x-2"
    }, y("div", {
